function [A_hat, E_hat, iter] = Block2and1norm_inexact_alm_rpca(D, H, W, lambda, tol, maxIter)
...
while ~converged       
    ...
    % im1 = uint8(im1); % outputFileName = sprintf('A%d.jpg',j); %imwrite(im1, outputFileName );   
