function [A_hat E_hat iter] = gzsimpleblock_inexact_alm_rpca(D, lambda, tol, maxIter)
...
nW= 4*sqrt(m/12);
nH= 3*sqrt(m/12);
nSetBlock=16; %the block size will be nSetBlock*nSetBlock
