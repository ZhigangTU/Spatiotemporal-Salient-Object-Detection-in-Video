function PixelSeedMask = gzMotionConsistentAnalysis(MaskBlock1Pixle2, E_blockmask, PixelMask, uflowdata, vflowdata, normflowdata, data)
...
%                     searchW1 = curW + xNeibor(nSearch1);
            ...
            [bConsistent, MaxDiffangle] = gzAnalyseTrackinginfoMatrix(TrackinfoMatrix);
            if bConsistent
...
for j = 1:n,
    ...
    for jh = 1:nBH,
        for jw = 1:nBW,
            ...
            cleanBlock(nhStart : nhStart + nSize -1, nwStart : nwStart + nSize -1)=CleanSeed(jh,jw)*ones(nSize,nSize);   
        end
    end
