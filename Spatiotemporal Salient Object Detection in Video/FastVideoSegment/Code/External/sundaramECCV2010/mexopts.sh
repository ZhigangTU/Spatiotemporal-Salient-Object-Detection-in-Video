...
#----------------------------------------------------------------------------
            ...
            CLIBS="$RPATH $MLIBS -L/home/mourgos/Workspace/Matlab/External/trackingLinux64/ -lm -lldof_gpu"
            COPTIMFLAGS='-O -DNDEBUG'
            CDEBUGFLAGS='-g'
            CLIBS="$CLIBS -lstdc++"
#
            ...
            CXXFLAGS="$CXXFLAGS -std=c++0x"
            CXXLIBS="$RPATH $MLIBS -L/home/mourgos/Workspace/Matlab/External/trackingLinux64/ -lm -lldof_gpu"
            CXXOPTIMFLAGS='-O -DNDEBUG'
            CXXDEBUGFLAGS='-g'
#
            # FortrankeyName: gfortran
