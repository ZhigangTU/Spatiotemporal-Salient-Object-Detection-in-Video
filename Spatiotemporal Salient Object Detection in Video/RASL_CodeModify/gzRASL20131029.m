% gaozhi wang yuxiang modified, for RASL
...
cropped_origin=[10,10]; 
canonical_size=[220,300]
raslpara.canonicalImageSize =[220,300];
%raslpara.canonicalImageSize =canonical_imgsz/2;


%raslpara.canonicalCoords = [ 5  55 ; ...
%                             32 32  ];
raslpara.canonicalCoords = [ 10  230 ; ...
                             32 32  ];
